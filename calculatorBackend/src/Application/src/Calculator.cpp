...
std::pair <std::string,bool> Calculator::runCalculator(std::string webInput)
{
    bool isValid = false;
    std::string finalResult;
    Parser parser;
    auto futureExpressionUnits = std::async(&Parser::getValidParsedEquationUnits, parser, parser.processUserInput(webInput));
