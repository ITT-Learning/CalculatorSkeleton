...
struct History FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *historyList() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(VT_HISTORYLIST);
  }
  flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *mutable_historyList() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(VT_HISTORYLIST);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_HISTORYLIST) &&
           verifier.VerifyVector(historyList()) &&
           verifier.VerifyVectorOfStrings(historyList()) &&
           verifier.EndTable();
  }
...
struct HistoryBuilder {
  ...
  void add_historyList(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>> historyList) {
    fbb_.AddOffset(History::VT_HISTORYLIST, historyList);
  }
...
inline flatbuffers::Offset<History> CreateHistory(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>> historyList = 0) {
...
inline flatbuffers::Offset<History> CreateHistoryDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<flatbuffers::String>> *historyList = nullptr) {
  auto historyList__ = historyList ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*historyList) : 0;
...
inline void History::UnPackTo(HistoryT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = historyList(); if (_e) { _o->historyList.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->historyList[_i] = _e->Get(_i)->str(); } } }
}
...
inline flatbuffers::Offset<History> CreateHistory(flatbuffers::FlatBufferBuilder &_fbb, const HistoryT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _historyList = _o->historyList.size() ? _fbb.CreateVectorOfStrings(_o->historyList) : 0;
  return calculator::schema::CreateHistory(
      _fbb,
      _historyList);
}
