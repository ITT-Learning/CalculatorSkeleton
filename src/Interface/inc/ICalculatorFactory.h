...
class ICalculatorFactory
{
    public:
         ...
         * 
         * @param [in] firstNumber firstNumber passed to specific calculator based on operation
         * @param [in] secondNumber secondNumber passed to specific calculator based on operation
         * @param [in] operation operation passed to determine which calculator to send firstNumber and secondNumber
