...
{
    constexpr char CalculatorStrings::BRACKET_CLOSE;
    constexpr char CalculatorStrings::BRACKET_OPEN;
    ...
    constexpr char CalculatorStrings::EXIT_1[];
    constexpr char CalculatorStrings::EXIT_2[];
    constexpr char CalculatorStrings::EXIT_3[];
    constexpr char CalculatorStrings::EXIT_4[];
    ...
    constexpr char CalculatorStrings::W4_MAIN_PROMPT[];
    constexpr char CalculatorStrings::W4_ADD2_FORMAT[];
    constexpr char CalculatorStrings::W4_ADD2_PROMPT[];
    constexpr char CalculatorStrings::W4_SQRT_FORMAT[];
    constexpr char CalculatorStrings::W4_SQRT_PROMPT[];
    constexpr char CalculatorStrings::W4_PYTH_FORMAT[];
